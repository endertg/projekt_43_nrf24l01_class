...
Returns:  none
**************************************************************************/
void uart::uart_init(unsigned int baudrate)
{
    UART_TxHead = 0;
    UART_TxTail = 0;
    UART_RxHead = 0;
...
**************************************************************************/
unsigned int uart::uart_getc(void)
{    
    unsigned char tmptail;
    unsigned char data;
...
Returns:  none          
**************************************************************************/
void uart::uart_putc(unsigned char data)
{
    unsigned char tmphead;
...
Returns:  none          
**************************************************************************/
void uart::uart_puts(const char *s )
{
    while (*s) 
      uart_putc(*s++);
...
Returns:  none
**************************************************************************/
void uart::uart_puts_p(const char *progmem_s )
{
    register char c;
...
Returns:  none
**************************************************************************/
void uart::uart1_init(unsigned int baudrate)
{
    UART1_TxHead = 0;
    UART1_TxTail = 0;
    UART1_RxHead = 0;
...
Returns:  lower byte:  received byte from ringbuffer
          higher byte: last receive error
**************************************************************************/
unsigned int uart::uart1_getc(void)
{    
    unsigned char tmptail;
    unsigned char data;
...
Returns:  none          
**************************************************************************/
void uart::uart1_putc(unsigned char data)
{
    unsigned char tmphead;
...
Returns:  none          
**************************************************************************/
void uart::uart1_puts(const char *s )
{
    while (*s) 
      uart1_putc(*s++);
...
Returns:  none
**************************************************************************/
void uart::uart1_puts_p(const char *progmem_s )
{
    register char c;
